        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 group">
              ...
              <span className="text-xl tracking-[-0.03em] font-satoshi">KORAX</span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <main className="space-y-32 py-32 mt-16">
          ...
          <div className="text-center space-y-8 relative">
            ...
            <h1 className="text-5xl sm:text-7xl font-satoshi tracking-[-0.03em] leading-tight">
              Transforming<br />
              ...
              </span> into <span className="text-white/90 relative inline-block group">
                Equity
                <span className="absolute bottom-0 left-0 w-0 h-px bg-white/20 group-hover:w-full transition-all duration-700" />
              </span>
            </h1>
            <p className="text-lg text-zinc-400 font-euclidCircularB tracking-[-0.04em] leading-relaxed max-w-2xl mx-auto">
              We develop <span className="text-white/90">white-label software</span> that transforms your audience into high-value digital assets and recurring revenue streams.
            </p>
        ...
        <footer className="py-8 text-center space-y-4">
          <div className="flex justify-center gap-4 sm:hidden">
            <Link
              href="/careers"
              className="text-sm font-euclidCircularB tracking-[-0.04em] text-zinc-500 hover:text-white transition-colors"
            >
              CAREERS
            </Link>
          </div>
          
          <p className="text-zinc-500 font-euclidCircularB tracking-[-0.04em] text-sm">
